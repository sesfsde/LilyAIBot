...
async def handle_callback(callback: types.CallbackQuery):
    ...
    if callback.data == "install":
        text = (
            ...
            "8️⃣ Войди в расширение: нажми на иконку/окно, введи свой ник, который ты ввела в Telegram и нажми «Войти».\n\n"
            "9️⃣ Готово! Открой приватный чат (PM) и нажми «Сгенерировать ответы». Lily предложит 3 варианта.\n\n"
            "🐾 *Настройка Lily AI*\n\n"
        "Чтобы Лиля видела чат и ники, используй **English** версию сайтов:\n\n"
        "🔹 *Stripchat:* выбери English в футере\n"
        "🔹 *Chaturbate:* выбери English в меню\n\n"
        "Это нужно, чтобы вместо имен не писало 'ЛС'. Ответы будут на английском, а тактика — на русском! ✨"
